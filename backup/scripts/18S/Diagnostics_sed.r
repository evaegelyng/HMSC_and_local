...
load(file = "sediment/18S/unfitted_models.RData")

chain1 <- from_json(readRDS(file="sediment/18S/post_file00.rds")[[1]])
chain2 <- from_json(readRDS(file="sediment/18S/post_file01.rds")[[1]])
chain3 <- from_json(readRDS(file="sediment/18S/post_file02.rds")[[1]])
chain4 <- from_json(readRDS(file="sediment/18S/post_file03.rds")[[1]])
...
saveRDS(fitTF, file = "sediment/18S/fitTF.rds")
...
text.file = file.path("sediment/18S/MCMC_convergence.txt")
...
pdf(file= file.path("sediment/18S/MCMC_convergence.pdf"))
if(showBeta){
  par(mfrow=c(2,1))
