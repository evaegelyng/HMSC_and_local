...
ggsave(p,file="results/Water/18S/18S_coef_wat_hab_s80.png",height=9,width=15)
...
ggsave(p,file="results/Water/18S/18S_coef_wat_hab_rich_s80.png",height=9,width=15)
...
ggsave(p,file="results/Water/18S/18S_coef_wat_sal_rich_s80.png",height=9,width=15)