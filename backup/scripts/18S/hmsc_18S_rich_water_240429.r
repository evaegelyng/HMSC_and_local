...
pdf("results/Water/18S/hist_18S_rich_p50prevclass_water_plus.pdf")
par(mfrow=c(1,2))
...
pdf("results/Water/18S/hist_18S_abund_p50prevclass_water_plus.pdf")
par(mfrow=c(1,2))
hist(P,xlim=c(0,1),breaks = seq(from=0,to=1,by=0.1), col = "grey", xlab = "Prevalence")
...
write.table(dataYrich1, file="tmp/Species_data_18S_filt_wat.tsv", sep= "\t")
