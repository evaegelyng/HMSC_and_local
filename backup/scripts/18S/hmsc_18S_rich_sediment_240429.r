...
write.table(dare, file = "tmp/Dare_18S_sed.tsv", sep = "\t", row.names = FALSE)
...
#Saving model
saveRDS(models, file = "results/sediment/18S/18S_240426.rds")
...
pdf("results/sediment/18S/diag_240426.pdf")
par(mfrow=c(1,2))
...
pdf("results/sediment/18S/diag_beta_240426.pdf")
plot(mpost$Beta)
dev.off()
