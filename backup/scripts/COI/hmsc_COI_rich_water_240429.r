...
DT1.2<-tax_glom(COSQ_w, taxrank="order")
...
pdf("results/Water/COI/hist_COI_rich_p50prevorder_water_plus.pdf")
par(mfrow=c(1,2))
...
pdf("results/Water/COI/hist_COI_abund_p50prevorder_water_plus.pdf")
par(mfrow=c(1,2))
hist(P,xlim=c(0,1),breaks = seq(from=0,to=1,by=0.1), col = "grey", xlab = "Prevalence")
...
write.table(dataYrich1, file="tmp/Species_data_COI_filt_wat.tsv", sep= "\t")
