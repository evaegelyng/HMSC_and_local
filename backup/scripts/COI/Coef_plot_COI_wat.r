...
ggsave("results/Water/COI/COI_coeff_wat_yesfish.png", Yes_fishing, width=10, height=9)
ggsave("results/Water/COI/COI_coeff_wat_nofish.png", No_fishing, width=10, height=9)
...
ggsave(p,file="results/Water/COI/coef_wat_hab.png",height=14,width=12)
