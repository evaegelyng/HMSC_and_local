...
DADAwang1<-readRDS("../../RDS/COI_no_c2_3reps.rds")
...
tax$supergroup[tax$new_phylum=="Bacillariophyta_NA"]<-"SAR_Stramenopiles"
...
samples <- data.frame(sample_id = colnames(otus_full_tax[,1:306]))
...
obj <- parse_tax_data(otus_full_tax,
                          class_cols = c("domain", "supergroup", "new_phylum","new_class"))
...
ggsave(hab_tree,file="../../Plots/Heattrees/Heattrees_COI_comb.pdf")                                                     
