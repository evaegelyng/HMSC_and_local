...
rep_agg<-aggregate(. ~ sample, otus, function(x) mean(x))
...
## Parameter settings inspired by https://rpubs.com/CPEL/NMDS
  ...
  set.seed(123)
  allmds <- metaMDS(wat, distance = "jaccard", autotransform = FALSE, maxit=999, k=3, trymax=250)
  ...
  write.table(site_scrs,file=paste("../Tekstfiler/Jaccard_18S_wat_All.txt",sep=""))
```
...
## Parameter settings inspired by https://rpubs.com/CPEL/NMDS
  ...
  ggsave(nmds_both,file=paste("../Plots/NMDS/NMDS_18S_both.png",sep=""))
```