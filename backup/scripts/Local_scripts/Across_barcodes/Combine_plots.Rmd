...
```{r boxplot habitat shannon}

euk <- readRDS("../../Plots/Boxplots/18S_habitat_shannon.rds")
coi <- readRDS("../../Plots/Boxplots/COI_habitat_shannon.rds")
pro <- readRDS("../../Plots/Boxplots/16S_habitat_shannon.rds")

ggsave(file="../../Plots/Boxplots/All_hab_shannon.png",ggarrange(euk,coi,pro,ncol=1,nrow=3,align="h"),width=30,height=40,units="cm")
```

```{r boxplot substrate}

euk_sub <- readRDS("../../Plots/Boxplots/18S_substrate_shannon.rds")
coi_sub <- readRDS("../../Plots/Boxplots/COI_substrate_shannon.rds")
pro_sub <- readRDS("../../Plots/Boxplots/16S_substrate_shannon.rds")

ggsave(file="../../Plots/Boxplots/All_substr_shannon.png",ggarrange(euk_sub,coi_sub,pro_sub,ncol=1,nrow=3,align="h",common.legend=TRUE,legend="top"),width=20,height=35,units="cm")
```
...
euk_hab_s <-readRDS("../../Plots/Venn/18S_sal_sed.rds")
euk_hab_w <-readRDS("../../Plots/Venn/18S_sal_wat.rds")
coi_hab_s <- readRDS("../../Plots/Venn/COI_sal_sed.rds")
coi_hab_w <- readRDS("../../Plots/Venn/COI_sal_wat.rds")
pro_hab_s <- readRDS("../../Plots/Venn/16S_sal_sed.rds")
pro_hab_w <- readRDS("../../Plots/Venn/16S_sal_wat.rds")

ggsave(file="../../Plots/Venn/Venn_all_sal.png",ggarrange(euk_hab_s,euk_hab_w,coi_hab_s,coi_hab_w,pro_hab_s,pro_hab_w,ncol=2,nrow=3,align="h",common.legend=TRUE,legend="top"),
       width = 100,
       height = 150,
       units = "mm",
       dpi = 200)
