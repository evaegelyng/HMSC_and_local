...
saveRDS(box_rich,"../Plots/Boxplots/COI_MOTU_rich.rds")
...
## Parameter settings inspired by https://rpubs.com/CPEL/NMDS
  ...
  #ggsave(nmds_both,file="../Plots/NMDS/NMDS_COI_both.png")
  
  #ggsave(file="../Plots/NMDS/NMDS_COI_both_substrates.png",ggarrange(plots_sub[[2]],plots_sub[[1]],ncol=1,nrow=2,align="h",common.legend=TRUE,legend="top"))
```

```{r divide by kingdom}

## Subset taxonomy table to each of three dominant kingdoms
chrom<-tax_70[which(tax_70$kingdom=="Chromista"),]
plant<-tax_70[which(tax_70$kingdom=="Plantae"),]
metaz<-tax_70[which(tax_70$kingdom=="Metazoa"),]
...
## Parameter settings inspired by https://rpubs.com/CPEL/NMDS
  ...
  write.table(site_scrs,file="../Tekstfiler/Jaccard_sed.txt")
...
## Parameter settings inspired by https://rpubs.com/CPEL/NMDS
  ...
  write.table(site_scrs_w,file="../Tekstfiler/Jaccard_wat.txt")
...
```
```{r nmds sed salinity kin}

datasets<-list(sed.chrom,sed.plant,sed.metaz)
names<-c("Chromista","Plantae","Metazoa")
...
datasets<-list(wat.chrom,wat.plant,wat.metaz)
names<-c("Chromista","Plantae","Metazoa")
...
ggsave(file="../Plots/NMDS/NMDS_70_both_sal_kingdoms.png",ggarrange(plots[[1]],plots_wat[[1]],plots[[2]],plots_wat[[2]],plots[[3]],plots_wat[[3]],ncol=2,nrow=3,align="h",common.legend=TRUE,legend="right"))
```