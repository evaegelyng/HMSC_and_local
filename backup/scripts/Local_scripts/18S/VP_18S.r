...
model<- readRDS("../../RDS/fitTF_18S_sed.rds")
model_w<- readRDS("../../RDS/fitTF_18S_wat.rds")

# Load table with corrected phylum names
tax<-read.table("../../Tekstfiler/18S/18S_classified_phy_class_curated.tsv",sep="\t",header=T)
...
# Add new phylum names
taxonomy_w$new_phylum<-tax$new_phylum[match(taxonomy_w$class_name,tax$class)]
...
ggsave("../../Plots/Var_par/18S_varpar_sed.png", plot = sed_plot, width=12, height=12)
...
ggsave("../../Plots/Var_par/18S_varpar_wat.png", plot = water_plot, width=12, height=12)
