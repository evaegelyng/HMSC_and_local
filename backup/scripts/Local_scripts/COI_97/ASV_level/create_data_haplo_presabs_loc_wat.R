...
# import data
initial_data<-read.table("../../../Tekstfiler/COI/COI_ASV/wat_ASVs_250512.txt", sep="\t", header=T, check.names = F)
...
metadata<-read.table("../../../Tekstfiler/COI/COI_ASV/Mads_metadata_water2_250515.txt", sep="\t", header=TRUE) # check if metadata file is correct
...
write.csv(Djost_df_mean,'../../../Tekstfiler/COI/COI_ASV/wat_Djost.txt')
...
hist(out,50)
mean(out,na.rm=T)
write.table(out, "../../../Tekstfiler/COI/COI_ASV/water_no_of_comp.txt",sep="\t", quote=F) 
