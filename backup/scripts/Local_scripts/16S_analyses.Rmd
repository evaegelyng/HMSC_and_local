...
saveRDS(box_rich,"../Plots/Boxplots/16S_rich.rds")

#ggsave(file="../Plots/Boxplots/16S_rich.png",box_rich)
```
...
venn.diagram(
  ...
  filename = '../Plots/Venn/16S_sed.png',
  cat.cex = 2,
  cex=2,
  margin=0.05,
  cat.fontface = "bold",
...
venn.diagram(
  ...
  lwd = 3,
  fill = c("yellowgreen", "cornflowerblue","thistle3"),
  filename = '../Plots/Venn/16S_wat.png',
  cat.cex = 2,
  cex=2,
  margin=0.05,
  cat.fontface = "bold",
...
## Parameter settings inspired by https://rpubs.com/CPEL/NMDS
  ...
  coord_fixed() +
  theme_classic() + 
  theme(legend.position = NA, legend.text = element_text(size = 8), legend.title = element_text(size = 8), axis.text = element_text(size = 6))+
  ggtitle("")
...
```{r nmds wat habitat}
 ...
 #ggsave(file="../Plots/NMDS/NMDS_16S_both_hab.png",ggarrange(plots_hab[[1]],plots_hab_w[[1]],ncol=2,nrow=1,align="h",common.legend=TRUE,legend="right"))
```
...
plots_wat<-list()
  ...
  #ggsave(file="../Plots/NMDS/NMDS_16S_both_sal.png",ggarrange(plots[[1]],plots_wat[[1]],ncol=2,nrow=1,align="h",common.legend=TRUE,legend="right"))
```
...
## Parameter settings inspired by https://rpubs.com/CPEL/NMDS
  ...
  #ggsave(nmds_both,file="../Plots/NMDS/NMDS_16S_both.png")
```