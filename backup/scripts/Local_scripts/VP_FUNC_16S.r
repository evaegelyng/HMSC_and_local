...
model<- readRDS("../RDS/16S_sed_241007.rds")
model_w<- readRDS("../RDS/16S_wat_241007.rds")

COSQ_rare2<-readRDS("../RDS/16S_no_c2_3reps.rds")
...
ggsave("../Plots/Var_par/16S_varpar_sed.png", plot = the_plot, width=12, height=9)
...
ggsave("../Plots/Var_par/16S_varpar_wat.png", plot = water_plot, width=12, height=9)
