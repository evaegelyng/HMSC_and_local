...
rep_agg<-aggregate(. ~ sample, sp_97_t, function(x) mean(x))
...
for (i in 1:length(datasets)){
  ...
  plots[[i]]<-nmds_sed
  #ggsave(nmds_sed,file=paste("../Plots/NMDS/NMDS_97_sed_4areas",names[[i]],".png",sep=""))
...
for (i in 1:length(datasets.w)){
  ...
  ggsave(nmds_wat,file=paste("../Plots/NMDS/NMDS_97_wat_4areas",names[[i]],".png",sep=""))
