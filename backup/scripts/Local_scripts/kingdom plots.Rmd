...
tax18S<-read.table("../Tekstfiler/18S/cleaned_tax_pident90_lulu.txt", sep='\t', header=T, comment="")
...
#Extract relevant columns
otus_pr_kingdom <- kingdom_otu[,c(1,4)]
otus_pr_kingdom <-otus_pr_kingdom[order(-(otus_pr_kingdom$id)),]
colnames(otus_pr_kingdom)[2] = "No_of_OTUs"
```
...
bp_kingdom <- grid.arrange(bp18S,bp70,bp97,nrow=1,ncol=3)
```