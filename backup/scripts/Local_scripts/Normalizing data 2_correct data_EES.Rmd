...
# Calculate no. of reads per PCR replicate
## Find first sample column
pident70_marine[1:2,32:34] # column 34
## Extract sample columns
samples<-pident70_marine[,34:ncol(pident70_marine)]
...
# For HMSC-modeling, we removed OTUs with an "order score" (confidence of order-level assignment) below 95. To check consistency with the 97-dataset, we see how many OTUs were removed by this filtering
...
pident70_marine[which(pident70_marine$species=="Ephydatia fluviatilis"),] # 1 otu
...
#Remove any OTUs not assigned to phylum (none in this case)
