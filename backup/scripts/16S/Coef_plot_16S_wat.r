...
model<- readRDS("results/Water/16S/16S_wat_241007.rds")
...
ggsave("results/Water/16S/16S_coeff_wat_sal1.png", sal1, width=10, height=9)
ggsave("results/Water/16S/16S_coeff_wat_Si.png", Si, width=10, height=9)
ggsave("results/Water/16S/16S_coeff_wat_PO4.png", PO4, width=10, height=9)
ggsave("results/Water/16S/16S_coeff_wat_DN.png", DN, width=10, height=9)
ggsave("results/Water/16S/16S_coeff_wat_temp.png", Temperature, width=10, height=9)
ggsave("results/Water/16S/16S_coeff_wat_chl.png", Chlorophyll, width=10, height=9)
ggsave("results/Water/16S/16S_coeff_wat_sal2.png", sal2, width=10, height=9)
...
ggsave(p,file="results/Water/16S/coef_wat_hab.png",height=9,width=10)