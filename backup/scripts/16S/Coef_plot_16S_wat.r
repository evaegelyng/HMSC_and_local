...
ggsave(p,file="results/Water/16S/16S_coef_wat_hab.png",height=9,width=15)
...
ggsave(p,file="results/Water/16S/16S_coef_wat_hab_rich.png",height=9,width=15)
...
ggsave(p,file="results/Water/16S/16S_coef_wat_sal_rich.png",height=9,width=15)