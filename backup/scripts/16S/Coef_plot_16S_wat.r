...
model <- readRDS("results/Water/16S/fitTF.rds")
...
ggsave(p,file="results/Water/16S/16S_coef_wat_hab_s80.png",height=9,width=15)
...
ggsave(p,file="results/Water/16S/16S_coef_wat_hab_rich_s80.png",height=9,width=15)
...
ggsave(p,file="results/Water/16S/16S_coef_wat_sal_rich_s80.png",height=9,width=15)