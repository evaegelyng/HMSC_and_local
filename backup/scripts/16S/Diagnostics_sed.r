...
load(file = "sediment/16S/unfitted_models.RData")

chain1 <- from_json(readRDS(file="sediment/16S/post_file00.rds")[[1]])
chain2 <- from_json(readRDS(file="sediment/16S/post_file01.rds")[[1]])
chain3 <- from_json(readRDS(file="sediment/16S/post_file02.rds")[[1]])
chain4 <- from_json(readRDS(file="sediment/16S/post_file03.rds")[[1]])
...
saveRDS(fitTF, file = "sediment/16S/fitTF.rds")
...
text.file = file.path("sediment/16S/MCMC_convergence.txt")
...
pdf(file= file.path("sediment/16S/MCMC_convergence.pdf"))
if(showBeta){
  par(mfrow=c(2,1))
...
save(MF,MFCV,WAIC,file = "sediment/16S/model_fit.Rdata")