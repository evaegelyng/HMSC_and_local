...
ggsave(p,file="results/sediment/16S/16S_coef_sed_hab_s80.png",height=9,width=15)
...
ggsave(p,file="results/sediment/16S/16S_coef_sed_hab_rich_s80.png",height=9,width=15)
...
ggsave(p,file="results/sediment/16S/16S_coef_sed_sal_rich_s80.png",height=9,width=15)